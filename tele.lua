...
-- Teleport ke checkpoint tertinggi (puncak gunung)
...
-- 🗻 Tombol Teleport Puncak
local PeakBtn = Instance.new("TextButton")
PeakBtn.Size = UDim2.new(0.9, 0, 0, 40)
PeakBtn.Position = UDim2.new(0.05, 0, 0.9, 0)
PeakBtn.Text = "⛰️ Teleport Puncak"
PeakBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
PeakBtn.BackgroundColor3 = Color3.fromRGB(80, 60, 120)
PeakBtn.Font = Enum.Font.SourceSansBold
PeakBtn.TextSize = 18
PeakBtn.Parent = MainFrame
Instance.new("UICorner", PeakBtn).CornerRadius = UDim.new(0, 6)
...
PeakBtn.MouseButton1Click:Connect(function()
    local highest = GetHighestCheckpoint()
    if highest and LP.Character and LP.Character:FindFirstChild("HumanoidRootPart") then
        LP.Character:FindFirstChild("HumanoidRootPart").CFrame = highest.CFrame + Vector3.new(0,5,0)
    else
        PeakBtn.Text = "❌ Checkpoint tidak ditemukan!"
        task.wait(1.5)
        PeakBtn.Text = "⛰️ Teleport Puncak"
    end
end)
